return function(Iris, widgets)
	...
	Iris.WidgetConstructor("Group", {
		...
		Update = function(thisWidget)
			if thisWidget.arguments.Horizontal then
				thisWidget.Instance.UIListLayout.FillDirection = Enum.FillDirection.Horizontal
			else
				thisWidget.Instance.UIListLayout.FillDirection = Enum.FillDirection.Vertical
			end
		end,
		Discard = function(thisWidget)
			thisWidget.Instance:Destroy()
