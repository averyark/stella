...
Iris.WidgetConstructor("Group", {
    ...
    Generate = function(thisWidget)
        ...
        local fillDirection = thisWidget.Arguments.horizontal and Enum.FillDirection.Horizontal or Enum.FillDirection.Vertical

        local uiListLayout = UIListLayout(Group, fillDirection, UDim.new(0, Iris._config.ItemSpacing.X))
